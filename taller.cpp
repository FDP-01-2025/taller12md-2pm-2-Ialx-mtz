...
// -----------------------------
// FUNCION PARA MODIFICAR A UN ESTUDIANTE
void modificarEstudiante() {
    ...
    cout << "Ingrese el carnet del estudiante que desees modificar";
    cin >> buscado;
    ...
    if (archivo.is_open() && temp.is_open()){
        while (archivo >> e.nombre >> e.carnet >> e.edad) {
            if (e.carnet == buscado){
                cout << "Ingresa el nuevo nombre (sin espacios): ";
                cin >> nuevo.nombre;
                cout << "Ingresa el nuevo carnet: ";
                cin >> nuevo.carnet;
